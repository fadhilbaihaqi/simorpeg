...
@section('title', 'Detail Laporan Pegawai')
@section('content')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item active">Laporan Pegawai</li>
                                    ...
                                    <table class="table table-hover table-striped">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>{{ $penilaian ? $penilaian->problem_solving : '' }}</td>
                                            </tr>
                                            <tr>
                                                <td>2</td>
                                                <td>Membuat program kode yang mudah diperbaiki (Clean Code)</td>
                                                <td>{{ $penilaian ? $penilaian->clean_code : '' }}
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>3</td>
                                                <td>Merancang Database</td>
                                                <td>{{ $penilaian ? $penilaian->database : '' }} </td>
                                            </tr>
                                        </tbody>
                                    </table>
                                    <h6>A. Kepribadian</h6>
                                        ...
                                        <table class="table table-hover table-striped">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>{{ $penilaian ? $penilaian->responsibility : '' }}</td>
                                                </tr>
                                                <tr>
                                                    <td>2</td>
                                                    <td>Memimpin team dalam sebuah project</td>
                                                    <td>{{ $penilaian ? $penilaian->leadership : '' }}</td>
                                                </tr>
                                                <tr>
                                                    <td>3</td>
                                                    <td>Pengambilan keputusan dalam konflik project</td>
                                                    <td>{{ $penilaian ? $penilaian->decition : '' }}</td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </div>
